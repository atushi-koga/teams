...
class TopPageTest extends TestCase
{
    ...
    public function browsingRestriction()
    {
        return BrowsingRestriction::ofByArray([
            'age'    => $this->user->birthday->age,
    ...
    public function testCanCallSearchForTop()
    {
        ...
        $browsingRestriction = $this->browsingRestriction();
